...
public class HeimdallDBHelper extends SQLiteOpenHelper {
	 ...
	 * @param context
	 */
	public HeimdallDBHelper(Context context) {
		super(context, HeimdallApplication.getConstDatabaseName(), null, DATABASE_VERSION);
		this.setContext(context); 
	}

	public String getDatabaseName() {
		return HeimdallApplication.getConstDatabaseName();
	}
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(HeimdallDBHelper.class.getName(),
	...
	public long createApp(SQLiteDatabase db, ApplicationInfo applicationInfo) {
		...
		try{
            ...
            Log.e(HeimdallApplication.getDebugTag(), "Error inserting " + values, e);
            return -1;
		}
